...
def validate_all_python():
    """Quality Gate: проверить весь Python-код на синтаксис и импорт."""
    import ast
    ...
    # Исключаем venv, __pycache__, data, библиотеки
    ...
    print(f"\n🔍 Quality Gate — проверка {len(py_files)} Python-файлов\n")
    ...
    for f in sorted(py_files):
        ...
        try:
            ...
            errors.append(f"  ⚠️  {f.relative_to(repo)}: {e}")
